...
_G.packer_plugins = {
  ...
  ["live-server.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/user/.local/share/nvim/site/pack/packer/opt/live-server.nvim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  orgmode = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/orgmode",
